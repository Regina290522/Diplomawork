    ...
    with allure.step("Проверка фильтра 'Сначала новые'"):
        def filter_online(self, term):
            ...
            self._driver.find_element(By.XPATH,
                                      '//*[@id="__layout"]/div/div[3]/div[1]/div/div/div[1]/section/div[1]/div/div[1]/div').click()  # клик по релевантности
            self._driver.find_element(By.XPATH,
                                      '//*[@id="__layout"]/div/div[3]/div[1]/div/div/div[1]/section/div[1]/div/div[2]/div/div[2]').click()  # клик сначала новые
            return txt
